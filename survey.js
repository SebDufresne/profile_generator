        ...
        rl.question(`${profileQ.food}`, (food) => {
          ...
          rl.question(`${profileQ.sport}`, (sport) => {
            ...
            rl.question(`${profileQ.superpower}`, (superpower) => {
              ...
              console.log("My name is " + name + " , I like " +
                hobby + " and listening to " + music + ". My favourite" +
                " meal is " + meal + " and I prefer eating " + food +
                " my favorite sport is " + sport + " and my " +
               "superpower is " + superpower + ". Nice to meet you!");
            });
          });
        });
      });
